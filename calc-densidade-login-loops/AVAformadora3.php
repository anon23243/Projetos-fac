...
<header style="background-color:rgb(23, 23, 23); height:60px; padding:0px;  font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; ">
   ...
   <a href="AVAformadora1.php">
   <button class="button">PROBLEMA 1</button></a>
   <a href="AVAformadora2.php">
   <button class="button">PROBLEMA 2</button></a>
   <button class="button">PROBLEMA 3</button>
   ...
   <h4 style="margin-top:20px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Problema 3</h4>  
   <h1 style="margin-top:20px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">CALCULO DE DENSIDADE    </h1>
   <h4 style="margin-top:20px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Digite as informações conforme abaixo...</h4>
   <form   action="densidade.php" method="POST">
   <input type="text"  name="fmassa" placeholder="Massa (em Kg)" min="0" step="0.01" required autocorrect="off" spellcheck="false" autocomplete="off"  style="width:200px; height:35px; border-radius:20px; padding-left:10px; margin-top:50px;margin-bottom:0px;  border:solid 2px gray; background-color:white; text-align:left;  font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:15px; "></input>
   <br>
   <input type="text"   name="fvolume"  placeholder="Volume (em M³)"  min="0" step="0.01" required style="width:200px; height:35px; border-radius:20px; padding-left:10px; margin-top:10px;margin-bottom:0px; border:solid 2px gray; background-color:white; text-align:left;  font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:15px;  "></input>
   <br>
