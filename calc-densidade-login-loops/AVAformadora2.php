...
<header style="background-color:rgb(23, 23, 23); height:60px; padding:0px;  font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; ">
   ...
   <button class="button">PROBLEMA 2</button>
   ...
   <h4 style="margin-top:20px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Problema 2</h4>  
   <h1 style="margin-top:20px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">SISTEMA DE LOGIN USANDO DADOS DA MATRICULA UNISUAM</h1>
   ...
   <input type="text"  name="fmatricula" placeholder="Numero da Matricula" required autocorrect="off" spellcheck="false" autocomplete="off"  style="width:200px; height:35px; border-radius:20px; padding-left:10px; margin-top:50px;margin-bottom:0px;  border:solid 2px gray; background-color:white; text-align:left;  font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:15px; "></input>
   <br>
   <input type="password"   name="fsenha"  placeholder="Senha"  required style="width:200px; height:35px; border-radius:20px; padding-left:10px; margin-top:10px;margin-bottom:0px; border:solid 2px gray; background-color:white; text-align:left;  font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:15px;  "></input>
   <br>
